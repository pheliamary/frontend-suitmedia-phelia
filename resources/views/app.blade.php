    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=400&q=80"class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>EMC Healthcare: Digital Transformation</h5>
                    <p class="text-muted">Improving patient experiences with modern digital platforms.</p>
                </div>
            </div>

            <!-- Project 2 -->
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1596526131083-e8c633c948d2?auto=format&fit=crop&w=400&q=80"
class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>Multinational Tobacco Company: Digital Solutions</h5>
                    <p class="text-muted">Developing digital platforms to enhance customer experience.</p>
                </div>
            </div>

            <!-- Project 3 -->
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?auto=format&fit=crop&w=400&q=80"class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>Astra International: Digital Innovation Solutions</h5>
                    <p class="text-muted">Increasing efficiency for sales, customers, and employees.</p>
                </div>
            </div>

            <!-- Project 4 -->
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&w=400&q=80 "class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>Lintec: Wincos | Comprehensive Digital Marketing</h5>
                    <p class="text-muted">Enhance brand visibility for growth in the B2C market.</p>
                </div>
            </div>
            ...
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?auto=format&fit=crop&w=400&q=80" class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>LG Electronics | Improve Customer Journey and Experience</h5>
                    <p class="text-muted">Improve user experience through microsite development.</p>
                </div>
            </div>

            <!-- Project 6 -->
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1533750349088-cd871a92f312?auto=format&fit=crop&w=600&q=80" class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Danamon">
                <div>
                    <h5>Bank Danamon: Career Website Redesign</h5>
                    <p class="text-muted">Building a visually appealing website to attract top talent.</p>
                </div>
            </div>
            ...
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?auto=format&fit=crop&w=400&q=80" class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>BRI Manajemen Investasi | Brand Development Journey</h5>
                    <p class="text-muted">Providing brand communication to increase public awareness.</p>
                </div>
            </div>

            <!-- Project 8 -->
            <div class="col-12 d-md-flex align-items-center">
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=600&q=80" class="img-fluid rounded me-md-4 mb-3 mb-md-0" style="max-width: 300px;" alt="Infomedia Nusantara">
                <div>
                    <h5>Infomedia Nusantara: Digital Marketing Implementation</h5>
                    <p class="text-muted">Elevating brand awareness with a winning strategy.</p>
                </div>
            </div>
