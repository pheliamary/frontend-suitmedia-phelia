      ...
      <img src="{{ asset('suitmedialogo.png') }}" alt="Suitmedia" style="height: auto; width: 90px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-btn text-white" href="/peminjam
                        " data-page="careers">
...
<div class="main-content-wrapper">
    <div class="container py-5">
        <div class="text-center mb-5">
            <h1 class="fw-bold">Digital Solutions for the Future</h1>
            <p class="lead text-muted">
                We build high-performance, scalable, and secure digital solutions. Our services include:
            </p>
        </div>
        ...
        <div class="row justify-content-center mb-4">
            <div class="col-md-10">
                <p class="fs-5 mb-4">
                    <strong>iOS and Android Development</strong> – We craft top-notch mobile apps that combine performance, user experience, and security. Whether you're launching a new product or scaling an existing one, our mobile team is ready to deliver.
                </p>
                <p class="fs-5 mb-4">
                    <strong>Web Development</strong> – From responsive layouts to optimized backend systems, we ensure a seamless and superior user experience across all platforms and devices.
                </p>
                <p class="fs-5 mb-4">
                    <strong>E-commerce Solutions</strong> – We build powerful and user-friendly online stores designed to maximize conversions, integrate secure payments, and streamline the customer journey.
                </p>
                <p class="fs-5 mb-4">
                    <strong>Search Engine Optimization (SEO)</strong> – Dominate search engine results with strategic SEO practices that drive organic traffic, improve visibility, and grow your audience sustainably.
                </p>
                <p class="fs-5 mb-4">
                    All of our solutions are built with scalability and performance in mind—helping your business grow faster in the digital landscape.
                </p>
            </div>
        </div>

        <div class="text-center">
            <a href="#contact" class="btn btn-primary btn-lg px-4">Let’s Work Together</a>
        </div>
    </div>
</div>
<footer>
